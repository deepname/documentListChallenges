# Document List Challenges - MVC Application
...
Fetch initial documents from http://localhost:8080/documents on startup. Example document TOON:

```text
Attachments[2]: European Amber Lager,Wood-aged Beer
Contributors[3]{ID,Name}:
  1b41861e-51e2-4bf4-ba13-b20f01ce81ef,Jasen Crona
  2a1d6ed0-7d2d-4dc6-b3ea-436a38fd409e,Candace Jaskolski
  9ae28565-4a1c-42e3-9ae8-e39e6f783e14,Rosemarie Schaden
...
WebSocket for notifications on ws://localhost:8080/notifications -> Example notification TOON:
